...
<body class="home">
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="banner-form">
                        <form class="form-inline">
                            ...
                            <button onclick="location.href='restaurants.php'" type="button" class="btn theme-btn btn-lg">Click to foresee the restaurants</button>
                        </form>
                    </div>
                    <div class="steps">
        ...
        <div class="app-wrap" style="margin-bottom: 11px;">
                <div class="container">
